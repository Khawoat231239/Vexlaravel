              ...
              <div class="tab-content">
                <div id="signup">   
                  ...
                  <div class="top-row">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="Apple Watch" autocomplete="off"/>
                  </div>
                     <div class="field-wrap">
                    <h4 style="color: white">Product Code</h4>
                     <input type="text" class="form-control" name="Code" id="Code" value="3325" />
                    </div>
